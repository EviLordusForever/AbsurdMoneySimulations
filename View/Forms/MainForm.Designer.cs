namespace AbsurdMoneySimulations
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.button8.Size = new System.Drawing.Size(456, 23);
			this.button8.TabIndex = 7;
			this.button8.Text = "Neural Battle";
			...
			this.button9.Text = "Swarm Statistics (csv)";
			...
			this.button10.Text = "Some kind of OTC indicator";
			...
			this.button3.Text = "Neural Network Statistics (csv)";
			...
			this.button15.Text = "Delete cookies for current domain";
			...
			this.panel5.Size = new System.Drawing.Size(464, 89);
			...
			this.button18.Size = new System.Drawing.Size(456, 23);
			this.button18.TabIndex = 10;
			this.button18.Text = "Fake OTC";
