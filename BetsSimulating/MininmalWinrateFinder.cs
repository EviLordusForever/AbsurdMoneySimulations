...
namespace AbsurdMoneySimulations
{
	public static class MinimalWinrateFinder
	{
		public static void MakeTable()
		{
			...
			Bitmap bmp = new Bitmap(2700, 1920);
			...
			{
				FormsManager._showForm.BackgroundImage = Graphics2.RescaleBitmap(bmp, FormsManager._showForm.ClientSize.Width, FormsManager._showForm.ClientSize.Height);
			}));
